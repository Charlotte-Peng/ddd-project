...
import org.pj.metaverse.entity.BasePageParam;
import org.pj.metaverse.entity.vo.TaskVo;
import org.pj.metaverse.constants.ProcessConstants;
...
public class CamundaUtils {
    ...
    public static Map convertProcessVariablesFromEntity(Object processVariables) {
        return processVariables instanceof Map
                ? (Map) processVariables
                : JSON.parseObject(processVariables.toString(),Map.class);
    }
    ...
    /**
     * 转换Java队形为Camunda ObjectValue(序列化格式为Json)
     *
     * @param obj Java对象
     * @param <T> Java对象类型
     * @return Camunda ObjectValue
